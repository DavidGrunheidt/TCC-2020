...
\begin{table}[h]
\centering
\caption{Reduções minima e máxima ao comparar-se os tempos dos processos \slaves.}
...
FN    & Huge  & 2  & 34412.07 & 1952.39 & 94.33 & Small    & 16 & 267.9   & 15.14  & 94.35  \\
...
LU    & Tiny  & 2  & 0.28     & 0.78    & 57.14 & Huge     & 2  & 40.15   & 9.02   & 77.53  \\ 
...
\begin{table}[h]
\centering
\caption{Reduções minima e máxima ao comparar-se os tempos do processo \master.}
...
\begin{table}[h]
\centering
\caption{Reduções minima e máxima ao comparar-se os tempos de comunicação.}
\label{tab:commtable}
\scalebox{0.6}{
\begin{tabular}{l c c c c c c c c c l}
App & \multicolumn{5}{c}{Redução Mínima} & \multicolumn{5}{c}{Reduçã Máxima}
