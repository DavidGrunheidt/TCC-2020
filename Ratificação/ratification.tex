...
\begin{figure}[!h]
	\begin{center}
		...
		\begin{ganttchart}[
            ...
            \ganttbar{1. Estudo e alteração das versões do CAP Bench}{7}{7} \\
            \ganttbar{2. Estudo da fundamentação teórica}{7}{7} \\
            \ganttbar{3. Escrita do relatório do TCC I}{7}{8} \\
            \ganttbar{3. Refinamento do relatório do TCC I}{9}{11} \\
            \ganttbar{4. Entrega do relatório do TCC I}{12}{12} \\
