...
É possível conferir a implementação do projeto citado acima e deste trabalho no seguinte repositório público do \textit{GitHub}: \href{https://github.com/DavidGrunheidt/CAPBench}{https://github.com/DavidGrunheidt/CAPBench}.
...
\begin{figure}[tb]
  ...
  \includegraphics[width=.55\linewidth, keepaspectratio]{mppamasterslave.pdf}
...
Dentre os \benchs clássicos da comunidade de \HPC, o \textit{NAS Parallel Benchmark} \cite{baileynasbench} se destaca por ter sido concebido puramente através de algoritmos, descrito por seus autores como um \bench com especificação de papel e caneta. Segundo os autores, optar por este caminho é uma maneira de evitar grande parte das dificuldades que uma implementação convencional de um \bench para sistemas \HPC enfrenta. Originalmente 7 \kernels foram descritos para o NAS, os quais simulam diferentes cargas de trabalho encontradas em aplicações \HPC. Todos estes \kernels usam ou uma \API de comunicação entre processos, como a \MPI, ou uma \API para sistemas com memória compartilhada, como a \OpenMP.
...
O \bench desenvolvido a partir desse trabalho se encontra no repositório público do \textit{GitHub} \href{https://github.com/DavidGrunheidt/CAPBench}{https://github.com/DavidGrunheidt/CAPBench}, onde é possível conferir toda implementação feita pelo autor.

\section{Alterações na \textit{Friendly Numbers}}
...
\section{Alterações na \textit{Gaussian Filter}}
...
\section{Alterações na \textit{LU Factorization}}
...
\begin{figure}[h]
  ...
  \includegraphics[width=1.1\linewidth, keepaspectratio]{master_time.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig:slavetime}
  \includegraphics[width=1.1\linewidth, keepaspectratio]{slave_time.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig:commtime}
  \includegraphics[width=1.1\linewidth, keepaspectratio]{comm_time.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig:datasent}
  \includegraphics[width=1.1\linewidth, keepaspectratio]{data_sent.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \includegraphics[width=1.1\linewidth, keepaspectratio]{data_received.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig:avgpower}
  \includegraphics[width=1.1\linewidth, keepaspectratio]{avg_power.pdf}
\end{figure}
...
\begin{figure}[h]
  ...
  \label{fig:energy}
  \includegraphics[width=1.1\linewidth, keepaspectratio]{energy.pdf}
\end{figure}
